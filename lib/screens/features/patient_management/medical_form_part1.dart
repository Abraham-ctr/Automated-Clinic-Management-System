...
class _MedicalFormPart1State extends State<MedicalFormPart1> {
  ...
  final TextEditingController admissionHistoryController =
      TextEditingController();
  ...
  final TextEditingController yellowFeverDateController =
      TextEditingController();
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildDropdownField(healthStatusController,
                          "How is your health?", ["Good", "Fair", "Poor"]),
                      const SizedBox(height: 10),
                      PatientTextfield(
                          controller: admissionHistoryController,
                          label: "Past Hospital Admissions",
                          isRequired: false),
                      const SizedBox(height: 10),
                      PatientTextfield(
                      ...
                      PatientTextfield(
                          ...
                          label: "Is your family healthy?",
                          isRequired: true),

                      const SizedBox(height: 10),
                      // **Immunization Records**
                      _buildYesNoField("Immunized for Yellow Fever?",
                          yellowFeverDateController),
                      const SizedBox(height: 10),
                      _buildYesNoField(
                          "Immunized for Small Pox?", smallPoxDateController),
                      const SizedBox(height: 10),
                      _buildYesNoField(
                          "Immunized for Tetanus?", tetanusDateController),
                      ...
                      MyButton(
                        ...
                        onPressed: () {
                          ...
                          if (_formKey.currentState?.validate() ?? false) {
                            ...
                            Navigator.pushNamed(context, '/registerPatient2',
                                arguments: formData);
                          }
                        },
                      ),
  ...
  Widget _buildDepartmentDropdown() {
    return DropdownButtonFormField<String>(
      value:
          departments.contains(selectedDepartment) ? selectedDepartment : null,
      decoration: InputDecoration(
  ...
  Widget _buildCourseDropdown() {
    List<String> courseOptions = selectedDepartment != null &&
            coursesByDepartment.containsKey(selectedDepartment)
