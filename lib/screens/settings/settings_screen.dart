...
class SettingsScreen extends StatelessWidget {
  ...
  void _exportPatientData(BuildContext context, String filter) async {
    try {
      ...
      if (filter == "By Registration Date") {
        patientsQuery = patientsQuery.orderBy("registrationDate", descending: true);
  ...
  void _showExportFormatDialog(BuildContext context, List<List<dynamic>> data, String fileName) {
  showDialog(
    context: context,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const SubAppBar(text: "Settings"),
  ...
  Widget _buildSettingsItem(IconData icon, String title, VoidCallback onTap, {Color color = Colors.black87}) {
    return ListTile(
